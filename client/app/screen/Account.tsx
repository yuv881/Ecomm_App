            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
                ...
                <View className="items-center py-10 px-5">
                    <View className="relative">
                        ...
                        />
                        <TouchableOpacity
                            className="absolute bottom-0 right-0 bg-black p-2 rounded-full border-2 border-white shadow-lg"
                        >
                ...
                <View className="px-5">
                    <Text className="text-[11px] font-black text-gray-400 uppercase tracking-[2px] mb-4 ml-1">
                        Account Settings
                    </Text>
                    ...
                    <View className="bg-gray-50 rounded-3xl overflow-hidden border border-gray-100">
                        {PROFILE_MENU.map((item, index) => (
                            <TouchableOpacity
                                ...
                                className={`flex-row items-center justify-between p-5 ${index !== PROFILE_MENU.length - 1 ? 'border-b border-gray-100' : ''}`}
                            >
                ...
                {/* Logout Button */}
                <TouchableOpacity
                    className="mx-5 mt-10 items-center justify-center py-5 rounded-3xl border-2 border-red-50 bg-red-50/20"
                >
                ...
                {/* App Version Info */}
                <Text className="text-center text-gray-300 font-extrabold text-[9px] mt-10 uppercase tracking-widest leading-loose">
